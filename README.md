### !!!
[Форк с более удобной CLI версией и расширенными функциями](https://github.com/Feqwy/mangalib-downloader-extended). Я не знаю когда я продолжу работу над этим проектом из за количества других тасков
